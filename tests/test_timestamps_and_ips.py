...
def test_first_with_all_timestamp_and_ip_options(capsys): 
    args = ["-t", "-i", "-I", "-f", "13", "testLogs/test_general.log"]
    util.main(args)
    captured = capsys.readouterr()
    expected = "Line 5: 127.255.0.10 23:59:59 192.168.255.255 0aF3:AF18:1762:B03:0:1:af19:17f tiI\nLine 12: 00:000:00:000:00:000:00:00 0.0.0.0 00:00:00 tiI\nLine 13: 09:17:17 : 2bc2:2a2d:98:dc3:0:18e0:aa7c:c0bd -- 234.098.125.251 200 tiI\n"
    assert captured.out == expected
...
def test_last_with_all_timestamp_and_ip_options(capsys): 
    args = ["-t", "-i", "-I", "-l", "13", "testLogs/test_general.log"]
    util.main(args)
    captured = capsys.readouterr()
    expected = "Line 12: 00:000:00:000:00:000:00:00 0.0.0.0 00:00:00 tiI\nLine 13: 09:17:17 : 2bc2:2a2d:98:dc3:0:18e0:aa7c:c0bd -- 234.098.125.251 200 tiI\nLine 15: 127.127.127.127 abcd:1234:ab:12:abcd:1234:cd:34 03:01:56 tiI\nLine 17: 119.243.4.69 88.133.63.210 17:59:00 17c8:d4ea:1cb2:afeb:d2b9:945e:6e6e:9152 tiI\n"
    assert captured.out == expected
    assert captured.err == ""

@pytest.mark.functional
def test_first_and_last_with_all_timestamp_and_ip_options(capsys): 
    args = ["-t", "-i", "-I", "-f", "13", "-l", "13", "testLogs/test_general.log"]
    util.main(args)
    captured = capsys.readouterr()
    expected = "Line 12: 00:000:00:000:00:000:00:00 0.0.0.0 00:00:00 tiI\nLine 13: 09:17:17 : 2bc2:2a2d:98:dc3:0:18e0:aa7c:c0bd -- 234.098.125.251 200 tiI\n"
    assert captured.out == expected
...
@pytest.mark.unit
def test_ip_highlighting(): 
    input = "119.243.4.69 54ad:92fb:9c62:dcc1:39fb:d679:73f4:b804 88.133.63.210 17:59:00 17c8:d4ea:1cb2:afeb:d2b9:945e:6e6e:9152"
    ...
    expected = "119.243.4.69 \x1b[42m54ad:92fb:9c62:dcc1:39fb:d679:73f4:b804\x1b[0m 88.133.63.210 17:59:00 \x1b[42m17c8:d4ea:1cb2:afeb:d2b9:945e:6e6e:9152\x1b[0m"
    assert actual == expected
    
    matches = ipv4_re.finditer(input)
    actual = util.highlight_ip_addresses(input, matches)
    expected = "\x1b[42m119.243.4.69\x1b[0m 54ad:92fb:9c62:dcc1:39fb:d679:73f4:b804 \x1b[42m88.133.63.210\x1b[0m 17:59:00 17c8:d4ea:1cb2:afeb:d2b9:945e:6e6e:9152"
    assert actual == expected
    
    input = actual
    matches = ipv6_re.finditer(input)
    actual = util.highlight_ip_addresses(input, matches)
    expected = "\x1b[42m119.243.4.69\x1b[0m \x1b[42m54ad:92fb:9c62:dcc1:39fb:d679:73f4:b804\x1b[0m \x1b[42m88.133.63.210\x1b[0m 17:59:00 \x1b[42m17c8:d4ea:1cb2:afeb:d2b9:945e:6e6e:9152\x1b[0m"
    assert actual == expected

@pytest.mark.unit
def test_split_by_idx(): 
...
class TestNegative: 
    ...
    def test_timestamp_and_ip_options_do_not_take_args(self, capsys, option): 
        '''
